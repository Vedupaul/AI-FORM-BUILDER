...
export const updateForm = asyncHandler(async (req, res) => {
    const form = await formService.updateForm(req.params.id, req.user._id, req.body);
...
export const publishForm = asyncHandler(async (req, res) => {
    ...
    const form = await formService.setPublishState(req.params.id, req.user._id, shouldPublish);
    sendSuccess(res, {

...
export const insightsApi = {
  ...
  inbox: (params?: any) => api.get("/inbox", { params }).then((r) => r.data.data),
};

// ---- Forms ----
export const formApi = {
  list: (params?: any) => api.get("/forms", { params }).then((r) => r.data.data.forms),
...
export const insightsApi = {
  ...
  inbox: (params?: any) => net(() => mock.inbox(params || {})),
};

// ---- Forms ----
export const formApi = {
  list: (params?: any) => net(() => mock.listForms(params || {})),
...
export const responseApi = {
  ...
  list: (formId, params?: any) => net(() => mock.listResponses(formId, params || {})),

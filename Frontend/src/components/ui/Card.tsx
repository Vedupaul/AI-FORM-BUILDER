...
export function Card({ className, hover = false, ...props }: { className?: string; hover?: boolean; [key: string]: any }) {
  return (
    <div
      className={cn(
...
export function CardBody({ className, ...props }: { className?: string; [key: string]: any }) {
